...
export const DemoPodcastListScreen = observer(function DemoPodcastListScreen(
  ...
  const onPressImage = () => {
    let imgUri = rnrImages[Math.floor(Math.random() * rnrImages.length)];
    setImageViewerList([imgUri]);
...
const EpisodeCard = observer(function EpisodeCard({
  ...
  return (
    <Card
      ...
      RightComponent={
        <TouchableOpacity onPress={() => onPressImage(imageUri)}>
